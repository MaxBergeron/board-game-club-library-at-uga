 ...
 document.addEventListener('DOMContentLoaded', () => {
  ...
  // sort by name
   document.querySelector('.sorting-links .linkName').addEventListener('click', e => {
    e.preventDefault();
    sortDescending1 = !sortDescending1; // Toggle sorting order
  ...
  document.querySelector('.sorting-links .linkRating').addEventListener('click', e => {
    e.preventDefault();
    sortDescending2 = !sortDescending2; // Toggle sorting order
  ...
  document.querySelector('.sorting-links .linkPlayers').addEventListener('click', e => {
    e.preventDefault();
    sortDescending3 = !sortDescending3; // Toggle sorting order
 ...
 // sort by play time
  document.querySelector('.sorting-links .linkTime').addEventListener('click', e => {
    e.preventDefault();
    sortDescending4 = !sortDescending4; // Toggle sorting order
  ...
  document.querySelector('.sorting-links .linkWeight').addEventListener('click', e => {
    e.preventDefault();
    sortDescending5 = !sortDescending5; // Toggle sorting order
  ...
  document.querySelector('.sorting-links .linkYear').addEventListener('click', e => {
    e.preventDefault();
    sortDescending6 = !sortDescending6; // Toggle sorting order
